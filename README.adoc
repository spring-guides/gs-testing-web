...
The Spring Initializr creates an application class (a class with a `main()` method) for you.
For this guide, you need not modify this class. The following listing shows the application class that
...
application context cannot start. The following listing shows how to do so:
...
.Kotlin
----
include::initial-kotlin/src/test/kotlin/com/example/testingweb/TestingWebApplicationTests.kt[]
----
...
.Kotlin
----
include::complete-kotlin/src/test/kotlin/com/example/testingweb/SmokeTest.kt[]
----
...
response. The following listing shows how to do so:
...
.Kotlin
----
include::complete-kotlin/src/test/kotlin/com/example/testingweb/HttpRequestTest.kt[]
----
...
.Kotlin
----
include::complete-kotlin/src/test/kotlin/com/example/testingweb/TestingWebApplicationTest.kt[]
----
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/testingweb/GreetingController.kt[]
----
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/testingweb/GreetingService.kt[]
----

Spring automatically injects the service dependency into the controller (because of the
constructor signature). The following listing shows how to test this controller
with `@WebMvcTest`:
